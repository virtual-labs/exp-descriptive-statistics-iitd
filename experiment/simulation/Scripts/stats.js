...
function calculateMean() 
  {
   ...
   // Code Below is showing it in the Page
    ...
    result.innerHTML = `<h2>${mean.toFixed(2)}</h2>`;
...
// For Median
  function calculateMedian() 
  {
   ...
   // Code Below is showing it in the Page
    ...
    result.innerHTML = `<h2>${median.toFixed(2)}</h2>`;
...
// For Mode 
  ...
  { 
   ...
   // Code Below is showing it in the Page
    let result = document.getElementById("data-result-area");
    result.innerHTML = `<h2>${mode.toFixed(2)}</h2>`;
...
// For Range 
  ...
  { 
   ...
   // Code Below is showing it in the Page
    let result = document.getElementById("data-result-area");
    result.innerHTML = `<h2>${range.toFixed(2)}</h2>`;
...
// For Kutosis 
  ...
  { 
   ...
   // Code Below is showing it in the Page
    let result = document.getElementById("data-result-area");
    result.innerHTML = `<h2>${kurtosis.toFixed(2)}</h2>`;
...
// For Skewness 
  ...
  { 
   ...
   // Code Below is showing it in the Page
    let result = document.getElementById("data-result-area");
    result.innerHTML = `<h2>${skewness.toFixed(2)}</h2>`;
...
// For Quantiles 
  ...
  { 
   ...
   // Code Below is showing it in the Page
    let result = document.getElementById("data-result-area");
    result.innerHTML = `<h2> Q1 = ${quantile1.toFixed(2)}, Q2 = ${quantile2.toFixed(2)}, Q3 =  ${quantile3.toFixed(2)}</h2>`;
